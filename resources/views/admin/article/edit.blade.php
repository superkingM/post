                     ...
                     @include('admin.layouts._flash')
                            <form class="am-form tpl-form-border-form tpl-form-border-br"
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea type="text" class="tpl-form-input" name="description" value="">{{$article->description}}</textarea>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="keywords" value="{{objToString($article->tags,'name')}}">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-6">
                                        <input type="text" class="tpl-form-input" name="title" value="{{$article->title}}">
                                    </div>
                                    <div class="am-u-sm-3">
                                ...
                                <div class="am-g am-margin-top">
                                    ...
                                    <div class="am-u-sm-8 am-u-md-8 am-u-end col-end">
                                        ...
                                        <div>
                                            <img src="{{$article->image}}" id="img_show" style="max-height: 200px;">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="markdown" class="editormd editormd-vertical"
                                         style="width: 100%; height: 300px;">
                                            <textarea rows="10" name="content" style="display:none;"
                                                      ...
                                                      placeholder="Enjoy Markdown! coding now...">{{$article->content}}</textarea>
                                    </div>
